...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    // Si el usuario no tiene el rol de administrador, enviar una respuesta 403 Forbidden
    http_response_code(403);

    // Establecer el mensaje HTML personalizado
    $htmlMessage = <<<HTML
...
<body>
    <div class="container">
        <header>
            <!-- Cambia la foto de perfil en función del rol del usuario -->
            <?php if ($_SESSION['rol'] === 'admin') { ?>
                <img src="../imagen_admin.png">
                <h1>Bienvenido Administrador <?php echo $_SESSION['nombre_usuario']; ?></h1>
                <p>Como administrador, tu función es gestionar y supervisar las tareas y proyectos de Mialu Studios Fin. Tienes acceso completo a todas las funcionalidades y puedes asignar tareas a otros miembros del equipo.</p>
            <?php } elseif ($_SESSION['rol'] === 'member') { ?>
                <img src="../imagen_member.png">
                <h1>Bienvenido Miembro <?php echo $_SESSION['nombre_usuario']; ?></h1>
                <p>Como miembro, tu función es trabajar en proyectos asignados por los administradores y colaborar con otros miembros del equipo. Utiliza este panel para acceder a las tareas y proyectos asignados a ti.</p>
            <?php } ?>
        </header>
        <nav class="menu">
            <ul>
