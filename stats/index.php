...
<body>
    ...
    <script>
        ...
        // Función para obtener datos en tiempo real desde la API
        function getData() {
            fetch('data.php')
                ...
                .then(data => {
                    ...
                    ramChart.data.labels.push(now.toLocaleTimeString());
        ...
        // Llama a la función getData para obtener datos cada 3 segundos
