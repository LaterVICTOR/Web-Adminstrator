...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT nombre, contrasena FROM usuarios WHERE nombre = '$nombre_usuario' AND contrasena = '$contrasena_actual'";
    $result = $conn->query($query);

    if ($result->num_rows > 0) {
        // Actualizar la contraseña en la base de datos
        $update_query = "UPDATE usuarios SET contrasena = '$nueva_contrasena' WHERE nombre = '$nombre_usuario'";
